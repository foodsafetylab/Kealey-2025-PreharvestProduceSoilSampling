---
title: "Raw Composition: SampleType x Wetting_Agent"
execute:
  echo: false
  message: false
  warning: false
...
There seems to be more similarities within groups (e.g., "Drags_PBS and Drags_BPW" compared to "Booties_PBS and Booties_BPW"). Between groups, Booties and Grabs seem to be a bit more similar than Drags. 
